...
class _PasswordresetCopyWidgetState extends State<PasswordresetCopyWidget> {
  ...
  void initState() {
    super.initState();
    emailAddress2Controller = TextEditingController();
    logFirebaseEvent('screen_view',
        parameters: {'screen_name': 'passwordresetCopy'});
  }
                  ...
                  children: [
                    Padding(
                      ...
                      child: FlutterFlowIconButton(
                        ...
                        onPressed: () async {
                          logFirebaseEvent(
                              'PASSWORDRESET_COPY_arrow_back_rounded_IC');
        ...
        children: [
          ...
          Padding(
            ...
            child: FFButtonWidget(
              onPressed: () async {
                logFirebaseEvent('PASSWORDRESET_COPY_Button-Login_ON_TAP');
                logFirebaseEvent('Button-Login_Auth');
                if (emailAddress2Controller!.text.isEmpty) {
                ...
                await resetPassword(
                  email: emailAddress2Controller!.text,
                  context: context,
                );
                ...
                await showDialog(
                  ...
                  builder: (alertDialogContext) {
                    return AlertDialog(
                      title: Text('Password Email Sent to Your Email'),
                      actions: [
                        TextButton(
